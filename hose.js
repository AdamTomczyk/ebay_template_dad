...
.weepictureone, .weepictureone:hover ~ .large-picture { background-image: url(${data.mainpic}) !important; }
.weepicturetwo, .weepicturetwo:hover ~ .large-picture { background-image: url(${data.secondpic}) !important; }
#hintergrund{
...
<h3 style="color:#494949;font-weight:400;">Fahrradhose</h3>
<div class="row">
...
<h3 style="font-weight:400;color:#2B2B2B;">100% Lycra-Stoff</h3>
</div>
...
<figure>
<div class="tab1"><p>
Die Radhose bildet das Fundament jedes Gipfelstürmers. Dank Cool Active, wasserabweisendem Material und einem dicken 3D-Sitzpolster ist diese Radhose die allzweck Waffe schlecht hin. <br><br>

Neuste Windstopper© Technologie sowie hochwertige Verarbeitung sorgen stets für die richtige Temperatur. Des weiteren besticht das Material durch seine aerodynamische Vielseitigkeit.
</p></div>
<div class="tab2"><p>
Das Produkt wird zu 100% in der EU hergestellt. Die Radhose wird aus hochwertigem LYCRA gefertigt. <br><br>
Die Trägerpartie ist aus einem leichteren dehnbaren Material gefertigt, dessen Fokus auf Komfort und Feuchtigkeitsableitung liegt. Zudem sorgt die Memory Technologie, dass sich der Stoff über die Zeit an den Körper optimal anpasst.
</p></div>
<div class="tab3"><p>
- 3D Sitzpolster<br>
- Windstopper Technologie<br>
...
<p style="font-weight: lighter;color:#444;line-height:25px">Die Radhose bildet das Fundament jedes Gipfelstürmers. Dank Cool Active, wasserabweisendem Material und einem dicken 3D-Sitzpolster ist diese Radhose die allzweck Waffe schlecht hin.
<br><br>
Neuste Windstopper© Technologie sowie hochwertige Verarbeitung sorgen stets für die richtige Temperatur. Des weiteren besticht das Material durch seine aerodynamische Vielseitigkeit.
</p><p>
</p></div>
...
<p style="font-weight:400;color:#444;line-height:25px">Das Produkt wird zu 100% in der EU hergestellt. Die Radhose wird aus hochwertigem LYCRA gefertigt.
...
<p style="color:#444;">- 3D Sitzpolster</p>
<p style="color:#444">- Windstopper Technologie</p>
...
<div class="col-lg-10 col-xl-10 d-none d-lg-block d-xl-none d-xl-block" style="background-image:url(https://i.postimg.cc/t916pC5Y/HoseSize.png); background-size:contain;background-position:center;background-repeat:no-repeat;color:transparent">
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
...
<thead>
<tr>
<td style="text-align:left;"><span style="font-weight:bold;">Hosen Größen</span></td>
...
<tbody>
<tr>
<td style="background-color:#FF8181;text-align:left;">A - Taillenumfang</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">31 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">35 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">36 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
...
<tr>
<td style="background-color:#5EECFF;text-align:left;">B - Oberschenkel Breite</td>
<td style="text-align:center;border-bottom: 1px solid white;
...
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">23 cm</td>
</tr>
<tr>
<td style="background-color:#9cfbad;text-align:left;">C - Schrittlänge</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">62 cm <br>-<br> 67 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">64 cm <br>- <br>69 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">66 cm <br>- <br>71 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">67 cm <br>- <br>72 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">68 cm <br>- <br>73 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">70 cm <br>- <br>75 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">72 cm <br>- <br>76 cm</td>
</tr>
