...
<h3 style="font-weight:400" class="font-weight-light"> <a href="https://www.ebay.de/sch/thomala/m.html?_nkw=&_armrs=1&_ipg=&_from=">Shop</a></h3>
</div>
<div class="col-sm-3 col-md-3 col-lg-2"><h3 style="font-weight:400;" class="font-weight-light"><a href="https://feedback.ebay.de/fdbk/feedback_profile/thomala?">Bewertungen</a></h3></div>
...
<h3 style="color:#494949;font-weight:400;">Fahrrad Trikot</h3>
<div class="row">
...
<figure>
<div class="tab1"><p>
Kurzarmiges Radlershirt, welches sich Ideal für Trainingseinheiten sowie für Tagestouren eignet.<br><br>
Das Hemd ist aus dünnen &amp; luftdurchlässigen Stoff verarbeitet.
Darüber hinaus besticht das Material der Italienischen Firma Miti Spa durch die hochwertige
Verarbeitung der Fasern wodurch dieses ebenfalls Wasserabweichend ist.
</p></div>
<div class="tab2"><p>
Das Produkt wird zu 100% in der EU hergestellt. Das Shirt besteht aus hochwertigem Polyster gefertigt. <br><br>
Das Shirt ist äussert belastungsfähig und langlebig. Dank Memory-Technologie passt sich das Material schnell dem Körper an um hohen tragekomfort zu gewährleisten.
Darüber hinaus ist das Shirt atmungsaktiv.
</p></div>
<div class="tab3"><p>
- Reißverschluss<br>
- Drei Rückentaschen<br>
- Gummiabschlußbund<br>
- 18mm dicke anti-bakteriellen Einlage<br>
- 100% Polyster
</p></div>
</figure>
</div>
...
<p style="font-weight: lighter;color:#444;line-height:25px">Kurzarmiges Radlershirt, welches sich Ideal für Trainingseinheiten sowie für Tagestouren eignet.
<br><br>
Das Hemd ist aus dünnen &amp; luftdurchlässigen Stoff verarbeitet. Darüber hinaus besticht das Material der Italienischen Firma Miti Spa durch die hochwertige Verarbeitung der Fasern wodurch dieses ebenfalls Wasserabweichend ist. </p><p>
</p></div>
<div class="col-1"></div>
<div class="col-5 d-none d-sm-none d-md-none d-lg-block d-xl-block">
...
<br><br>
Das Shirt ist äussert belastungsfähig und langlebig. Dank Memory-Technologie passt sich das Material schnell dem Körper an um hohen tragekomfort zu gewährleisten. Darüber hinaus ist das Shirt atmungsaktiv.</p><p>
</p></div>
</div>
...
<p style="color:#444;">- Gummiabschlußbund</p>
<p style="color:#444;">- 100% Polyster</p>
</div>
<div class="col-1"></div>
...
<div class="row">
<div class="col-lg-3 col-xl-3 d-none d-lg-block d-xl-none d-xl-block" style="border-top:1px solid rgba(0,0,0,.15)">
<div class="row">
...
<div class="col-lg-10 col-xl-10 d-none d-lg-block d-xl-none d-xl-block" style="background-image:url(https://i.postimg.cc/TYKF3bJm/Sizechart.png); background-size:contain;background-position:center;background-repeat:no-repeat;color:transparent">
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
...
<thead>
<tr>
<td style="text-align:left;"><span style="font-weight:bold;">Trikot Größen</span></td>
...
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">9 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
...
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">37 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
border-right: 1px solid white;padding:1%;">38 cm</td>
<td style="text-align:center;border-bottom: 1px solid white;
