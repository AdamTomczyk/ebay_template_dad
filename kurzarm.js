...
.jumbotron{
background-image: url("https://i.postimg.cc/X4ZPsdg0/s-l1600.png");
...
.weepictureone, .weepictureone:hover ~ .large-picture { background-image: url(https://i.postimg.cc/X4ZPsdg0/s-l1600.png) !important; }
.weepicturetwo, .weepicturetwo:hover ~ .large-picture { background-image: url(https://i.postimg.cc/TfZ4F1k5/s-l16002.png) !important; }
#hoverbutton{
...
#hintergrund{
background-image: url("https://i.postimg.cc/z52Mw0Kj/bmcTWO.jpg");
background-size:cover;
background-color:lightgrey;
background-position:center bottom;
}
#hintergrund2{
background-image: url("https://i.postimg.cc/8Dz9rqJc/bmcONE.jpg");
background-size:cover;
background-color:lightgrey;
background-position:center;
}
...
<div class="col-sm-3 col-md-3 col-lg-2"><h3 style="font-weight:400;" class="font-weight-light"><a href="https://www.ebay.de/fdbk/feedback_profile/thomala?filter=feedback_page:All" id="rater">Bewertungen</a></h3></div>
...
<h3 style="color:#494949;font-weight:400;">Kurzarm Trikot</h3>
<div class="row">
<div class="col-sm-6 col-md-5 col-lg-6 col-xl-6">
<h1 style="font-weight:400;color:#2B2B2B;">${data.team}</h1>
</div>
<div class="col-sm-6 col-md-6 col-lg-5">
<h1 style="font-weight:400;color:#2B2B2B;">86€</h1>
</div>
</div>

<h3 style="font-weight:400;color:#2B2B2B;">Gr S/M/L/XL/XXL</h3>

<div class="row">
<div class="col-sm-12 col-md-4 col-lg-5">
<h3 style="font-weight:400;color:#2B2B2B;">Windstopper<span style="caret-color: rgb(68, 68, 68); color: rgb(68, 68, 68); letter-spacing: 0.4000000059604645px; font-size: large;">®</span></h3>
</div>
...
<a href="https://www.ebay.de/bin/ctb?item=304156679708&amp;rev=12&amp;fromPage=2047675&amp;fb=1"><button type="button" class="btn btn-primary" id="hoverbutton"><h1 style="font-weight:400;color:white;">Sofort-Kaufen</h1></button></a>
</div>
</div>
...
<div class="col-lg-10 col-xl-10 d-none d-lg-block d-xl-none d-xl-block" style="background-image:url(https://i.postimg.cc/LHP5cxRt/size-Chart-Long2.png); background-size:contain;background-position:center;background-repeat:no-repeat;color:transparent">
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
<h1>Test</h1>
